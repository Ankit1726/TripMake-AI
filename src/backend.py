import os, operator, uuid, sqlite3
...
# Cloud Postgres has been removed entirely. LangGraph thread/conversation
# state is now persisted to a local SQLite file (see src/database/db.py),
# so this app has no external database dependency to expire or go down.
CHECKPOINT_DB_PATH = get_database_url()
